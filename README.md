# Kaggle Competition for   Costa-Rica-household-poverty-prediction

it is a Kaggle competition for household poverty prediction in Costa Rica. Data is provided by IDB (the largest source of development financing for Latin American and Caribbean). The main target of the competition is to help with income qualification for some of the world's poorest families.
webiste link: https://www.kaggle.com/c/costa-rican-household-poverty-prediction
...
# Before starting
this kernel is inspired by Will Koehrsen's marvel sequel in datascience. most of the methodologies are imitate from his code. so, thanks for his detailed blog for my first complete kaggle kernel.
